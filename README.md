...
Bayes’ theorem is a very important theorem in the field of probability and statistics.  The Bayes’ theorem describes the probability 
...
In the Bayes’ theorem, P (A) represents the probabilities of each event. In the Naïve Bayes Classifier, we can interpret these as 
`Class Probabilities`. It is simply the frequency of each instance of the event divided by the total number of instances.
